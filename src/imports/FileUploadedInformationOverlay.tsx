import svgPaths from "./svg-y5prg77aw1";
...
function Title1() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Public_Sans:Medium',_sans-serif] font-medium gap-[4px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Title">
      ...
      <p className="leading-[16.25px] relative shrink-0 text-[#69737b] text-[13px] tracking-[-0.065px] w-full">{`500 records found. `}</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Container">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Container">
          <path clipRule="evenodd" d={svgPaths.p268f4800} fill="var(--fill-0, #69737B)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function TrashFancy() {
  return (
    <div className="content-stretch flex items-start overflow-clip relative shrink-0" data-name="trash-fancy">
      <Container6 />
    </div>
  );
}
...
export default function FileUploadedInformationOverlay() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-start relative shadow-[-8px_0px_10px_0px_rgba(0,0,0,0.05),-1px_0px_1px_0px_rgba(0,0,0,0.1)] size-full" data-name="File Uploaded Information Overlay">
      <DrawerHeader />
      <DrawerBody />
      <DrawerFooterDefault />
    </div>
