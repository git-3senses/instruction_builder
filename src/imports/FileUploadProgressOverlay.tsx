import svgPaths from "./svg-1uvzx2inb2";
...
function Title1() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Public_Sans:Medium',_sans-serif] font-medium gap-[4px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Title">
      ...
      <p className="leading-[16.25px] relative shrink-0 text-[#69737b] text-[13px] tracking-[-0.065px] w-full">40%</p>
    </div>
  );
}
...
function ProgressBar() {
  return (
    <div className="bg-[#dde3e7] h-[4px] overflow-clip relative rounded-[9px] shrink-0 w-full" data-name="Progress bar">
      <div className="absolute bg-[#eb9600] bottom-0 left-0 right-[74.51%] rounded-[23px] top-0" />
    </div>
  );
}
...
export default function FileUploadProgressOverlay() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-start relative shadow-[-8px_0px_10px_0px_rgba(0,0,0,0.05),-1px_0px_1px_0px_rgba(0,0,0,0.1)] size-full" data-name="File Upload Progress Overlay">
      <DrawerHeader />
      <DrawerBody />
      <DrawerFooterDefault />
    </div>
